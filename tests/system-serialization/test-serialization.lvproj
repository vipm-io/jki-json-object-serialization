...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="test-system.lvclass" Type="LVClass" URL="../test-system/test-system.lvclass"/>
		<Item Name="test-device.lvclass" Type="LVClass" URL="../test-device/test-device.lvclass"/>
		<Item Name="test-group.lvclass" Type="LVClass" URL="../test-group/test-group.lvclass"/>
		<Item Name="test-channel.lvclass" Type="LVClass" URL="../test-channel/test-channel.lvclass"/>
		<Item Name="channel-child.lvclass" Type="LVClass" URL="../channel-child/channel-child.lvclass"/>
		<Item Name=" test-group-legacy.lvclass" Type="LVClass" URL="../test-group-legacy/ test-group-legacy.lvclass"/>
		<Item Name="Test - system-serialization.vi" Type="VI" URL="../Test - system-serialization.vi"/>
